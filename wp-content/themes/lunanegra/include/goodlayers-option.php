<?php
	...
	*/
	...
	function add_goodlayers_panel(){
		...
		$page = add_menu_page('Luna Negra Option', THEME_FULL_NAME, 'administrator', 'goodlayers_admin_panel', 'create_goodlayers_panel' /*,  GOODLAYERS_PATH.'/include/images/portfolio-icon.png' */);
	...
	function create_goodlayers_panel(){
		...
		<form name="goodlayer-panel-form" id="goodlayer-panel-form">
			...
			<?php
				...
				echo '<img src="' . GOODLAYERS_PATH . '/include/images/admin-panel-logo.png"/>';
				echo '</div>';
				...
				echo '<div class="panel-goodlayers-text">Luna Negra</div>';
